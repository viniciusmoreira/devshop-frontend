...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-200">
        ...
        <div className={(sidebar ? 'translate-x-0 ease-out' : '-translate-x-full ease-in') + "fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0"}>
            ...
            <header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
                ...
                <div className="flex items-center">
                    <div className="relative">
                        <button onClick={() => setNotification(old => !old)}
                        ...
                        { notification && <div onClick={closeNotification}
                            className="block fixed inset-0 h-full w-full z-10"></div> }
    
                        { notification && <div 
                            className="block absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10">
                            <a href="#"
                    ...
                    <div className="relative">
                        ...
                        { dropdown && <div onClick={closeDropdown} className="block fixed inset-0 h-full w-full z-10"></div> }
    
                        { dropdown && <div
                            className="block absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10">
                            <a href="#"
